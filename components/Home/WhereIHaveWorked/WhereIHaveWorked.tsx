...
import Fiverr from "./Descriptions/Fiverr";
import Spark from "./Descriptions/Spark";
import Internspk from "./Descriptions/Internspk";
...
import Huawei from "./Descriptions/Huawei";
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("HUAWEI");
  return (
