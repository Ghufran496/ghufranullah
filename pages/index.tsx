...
export default function Home() {
  ...
  const meta = {
    title: "Ghufran Ullah - Software Engineer",
    description: `A software engineer graduate with expertise in full stack development, specializing in ReactJS, Next.js, Node.js and
 ASP.NET Core Web Api. Committed to building innovative, high-quality websites and applications. Eager to collaborate
 with experienced team members on impactful software projects through high-quality, efficient work, aiming to enhance my
 technical skills, gain industry experience, and grow professionally.`,
    image: "/img/ghufranpic.png",
    type: "website",
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:site" content="@Ghufran" />
      ...
      {!isBlackListed ? (
        <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
          ...
          {context.sharedState.finishedLoading ? (
            <Footer githubUrl={"https://github.com/Ghufran496"} hideSocialsInDesktop={true} />
          ) : (
            <></>
          )}
